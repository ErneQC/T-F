...
from threads import Concentrator, Inversor, Irradiation, Nuvol, Curve_IV
import sys
import time
import queue
...
class UiActions(QMainWindow):
    ...
    def init_concentrator(self):
        ...
        #self.concentrator_thread.log_signal.connect(self.logTextEdit)
    ...
    def init_inversor(self):
        ...
        #self.inversor_thread.log_signal.connect(self.logTextEdit)
    ...
    def init_irradiation(self):
        ...
        #self.irradiation_thread.log_signal.connect(self.logTextEdit)
        self.irradiation_thread.start()
    def init_nuvol(self):
        #afegir les senyals que connecten amb els threads per vincularles a les funcions
        self.nuvol_thread.conn_signal.connect(self.statNuvol)
        #self.nuvol_thread.log_signal.connect(self.logTextEdit)
